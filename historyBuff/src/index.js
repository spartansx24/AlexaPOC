...
function getWelcomeResponse(response) {
    ...
    var speechOutput = "<p>History buff.</p> <p>What day do you want events for?</p>";
...
function handleFirstEventRequest(intent, session, response) {
    ...
    getJsonEventsFromWikipedia(monthNames[date.getMonth()], date.getDate(), function (events) {
        ...
        if (events.length == 0) {
            ...
            response.askWithCard({speech: "<speak>" + prefixContent + speechText + "</speak>", type: AlexaSkill.speechOutput.SSML},
                    {speech: repromptText, type: AlexaSkill.speechOutput.PLAIN_TEXT}, cardTitle, cardContent);
        }
    });
}
...
function handleNextEventRequest(intent, session, response) {
    ...
    response.askWithCard({speech: "<speak>" + speechText + "</speak>", type: AlexaSkill.speechOutput.SSML},
            {speech: repromptText, type: AlexaSkill.speechOutput.PLAIN_TEXT}, cardTitle, cardContent);
}
